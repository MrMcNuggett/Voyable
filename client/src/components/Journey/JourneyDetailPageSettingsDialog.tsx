...
export function JourneySettingsDialog({ journey, onClose, onSaved, onOpenInvite, onRefresh }: {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-end md:items-center justify-center md:p-5 overscroll-none bg-[var(--overlay)]" onClick={handleClose} onTouchMove={e => { if (e.target === e.currentTarget) e.preventDefault() }}>
