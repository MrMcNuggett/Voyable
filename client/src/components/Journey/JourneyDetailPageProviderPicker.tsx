...
export function ProviderPicker({ provider, userId, entries, trips, existingAssetIds, onClose, onAdd }: {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-end md:items-center justify-center md:p-5 overscroll-none bg-[var(--overlay)]" onClick={onClose} onTouchMove={e => { if (e.target === e.currentTarget) e.preventDefault() }}>
